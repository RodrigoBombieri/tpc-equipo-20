...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <asp:Button ID="btnGuardarCrear" Text="Guardar y Crear incidencia" CssClass="btn btn-primary" runat="server" OnClick="btnGuardarCrear_Click" />
            </div>
            ...
            <div class="col-md-2">
                <asp:Button ID="btnGuardarEdicionCrear" Text="Guardar y Crear incidencia" CssClass="btn btn-primary" runat="server" OnClick="btnGuardarEdicionCrear_Click" />
            </div>
            <%}
                else
                { %>
            ...
            <div class="col-md-2">
                <asp:Button ID="CrearIncidencia" Text="Crear incidencia" CssClass="btn btn-primary" runat="server" OnClick="CrearIncidencia_Click" />
            </div>
            <%    }%>
            <div class="col-md-1">
